(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CoveoJsSearchTests"] = factory(require("Coveo"));
	else
		root["CoveoJsSearchTests"] = factory(root["Coveo"]);
...
/***/ "./node_modules/exports-loader/index.js?window.$!./lib/jquery.js":
/*!**************************************************************!*\
  !*** ./node_modules/exports-loader?window.$!./lib/jquery.js ***!
  \**************************************************************/
 ...
 */ (function(
  ...
  b.each({ Height: "height", Width: "width" }, function(e, n) {
    ...
    (e.jQuery = e.$ = b),
     true &&
      __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js").jQuery &&
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./Fake/FakeAnalyticsEvents */ "./src/Fake/FakeAnalyticsEvents.ts"));
__export(__webpack_require__(/*! ./Fake/FakeEventArgs */ "./src/Fake/FakeEventArgs.ts"));
__export(__webpack_require__(/*! ./Fake/FakeFields */ "./src/Fake/FakeFields.ts"));
__export(__webpack_require__(/*! ./Fake/FakeGroupBy */ "./src/Fake/FakeGroupBy.ts"));
__export(__webpack_require__(/*! ./Fake/FakeResults */ "./src/Fake/FakeResults.ts"));


/***/ }),

/***/ "./src/Fake/FakeAnalyticsEvents.ts":
/*!*****************************************!*\
  !*** ./src/Fake/FakeAnalyticsEvents.ts ***!
  \*****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
function createFakeSearchEvent(token) {
...
exports.createFakeSearchEvent = createFakeSearchEvent;
function createFakeClickEvent(token) {
    if (token === void 0) { token = "foo"; }
    return {
        actionCause: token + "actionCause",
        actionType: token + "actionType",
...
exports.createFakeClickEvent = createFakeClickEvent;


/***/ }),

/***/ "./src/Fake/FakeEventArgs.ts":
/*!***********************************!*\
  !*** ./src/Fake/FakeEventArgs.ts ***!
  \***********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
function createPopulateOmniboxEventArgs(queryboxContent, cursorPosition, rows) {
    if (rows === void 0) { rows = []; }
    return {
...
exports.createPopulateOmniboxEventArgs = createPopulateOmniboxEventArgs;


/***/ }),

/***/ "./src/Fake/FakeFields.ts":
/*!********************************!*\
  !*** ./src/Fake/FakeFields.ts ***!
  \********************************/
/*! no static exports found */
...
function createFakeFieldValue(token, count) {
    coveo_search_ui_1.Assert.isNonEmptyString(token);
    return {
        value: token,
        lookupValue: token,
...
exports.createFakeFieldValue = createFakeFieldValue;
function createFakeFieldValues(token, count) {
    coveo_search_ui_1.Assert.isNonEmptyString(token);
    coveo_search_ui_1.Assert.isLargerOrEqualsThan(0, count);
    var fieldValues = [];
...
exports.createFakeFieldValues = createFakeFieldValues;


/***/ }),

/***/ "./src/Fake/FakeGroupBy.ts":
/*!*********************************!*\
  !*** ./src/Fake/FakeGroupBy.ts ***!
  \*********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var coveo_search_ui_1 = __webpack_require__(/*! coveo-search-ui */ "coveo-search-ui");
function createFakeGroupByResult(field, token, count, includeComputedValues) {
    coveo_search_ui_1.Assert.isNonEmptyString(field);
    coveo_search_ui_1.Assert.isNonEmptyString(token);
    coveo_search_ui_1.Assert.isLargerOrEqualsThan(0, count);
    var groupByValues = [];
    for (var i = 0; i < count; ++i) {
        groupByValues.push(createFakeGroupByValue(token + i.toString(), i + 1, 100 + i, includeComputedValues ? 1000 + i : undefined));
    }
    return {
        field: field,
...
exports.createFakeGroupByResult = createFakeGroupByResult;
function createFakeRangeGroupByResult(field, start, end, steps) {
    if (start === void 0) { start = 1; }
    if (end === void 0) { end = 100; }
    if (steps === void 0) { steps = 25; }
    var groupByValues = [];
    for (var i = start; i <= end; i += steps) {
        groupByValues.push(createFakeGroupByRangeValue(i, i + (steps - 1), "foobar" + i.toString(), i));
    }
    return {
        field: field,
        values: groupByValues
...
exports.createFakeRangeGroupByResult = createFakeRangeGroupByResult;
function createFakeHierarchicalValue(token, currentLevel, delimitingCharacter) {
    if (delimitingCharacter === void 0) { delimitingCharacter = "|"; }
    var value = "level:" + currentLevel.toString() + "--value:" + token;
    if (currentLevel !== 0) {
...
exports.createFakeHierarchicalValue = createFakeHierarchicalValue;
function createFakeHierarchicalGroupByResult(field, token, numberOfLevel, countByLevel, delimitingCharacter, includeComputedValues, weirdCasing) {
    ...
    for (var i = 0; i < numberOfLevel; ++i) {
        ...
        for (var j = 0; j < countByLevel; j++) {
            var currentValue = createFakeHierarchicalValue("" + token + j.toString(), i);
            if (weirdCasing) {
                currentValue = _.map(currentValue.split(delimitingCharacter), function (value, k) {
                    return (i + j + k) % 2 === 0 ? value.toLowerCase() : value.toUpperCase();
                }).join(delimitingCharacter);
            }
            var currentGroupByValue = createFakeGroupByValue(currentValue, j + 1, 100, includeComputedValues ? 1000 : undefined);
...
exports.createFakeHierarchicalGroupByResult = createFakeHierarchicalGroupByResult;
function createFakeGroupByValue(token, count, score, computedValue) {
    coveo_search_ui_1.Assert.isNonEmptyString(token);
    return {
        value: token,
        lookupValue: token,
...
exports.createFakeGroupByValue = createFakeGroupByValue;
function createFakeGroupByRangeValue(from, to, token, count, score, computedValue) {
    return {
        value: from + ".." + to,
        lookupValue: token,
        numberOfResults: count,
...
exports.createFakeGroupByRangeValue = createFakeGroupByRangeValue;


/***/ }),

/***/ "./src/Fake/FakeResults.ts":
/*!*********************************!*\
  !*** ./src/Fake/FakeResults.ts ***!
  \*********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var MockEnvironment_1 = __webpack_require__(/*! ../MockEnvironment */ "./src/MockEnvironment.ts");
var coveo_search_ui_1 = __webpack_require__(/*! coveo-search-ui */ "coveo-search-ui");
function createFakeResults(count, token) {
    ...
    return {
        searchUid: coveo_search_ui_1.QueryUtils.createGuid(),
        pipeline: "pipeline",
...
exports.createFakeResults = createFakeResults;
function createFakeResultsWithChildResults(count, numberOfChildResults, totalNumberOfChildResult) {
    if (count === void 0) { count = 10; }
    if (numberOfChildResults === void 0) { numberOfChildResults = 5; }
    if (totalNumberOfChildResult === void 0) { totalNumberOfChildResult = 5; }
    var results = [];
    for (var i = 0; i < count; ++i) {
        results.push(createFakeResultWithChildResult(i.toString(), numberOfChildResults, totalNumberOfChildResult));
    }
    return {
        searchUid: coveo_search_ui_1.QueryUtils.createGuid(),
        totalCount: count !== 0 ? count + 1 : 0,
...
exports.createFakeResultsWithChildResults = createFakeResultsWithChildResults;
function createFakeResult(token) {
    if (token === void 0) { token = "foo"; }
    return {
        title: "Title" + token,
        titleHighlights: [],
        ...
        raw: {
            ...
            urihash: coveo_search_ui_1.QueryUtils.createGuid(),
            source: "the source",
        ...
        searchInterface: MockEnvironment_1.mockSearchInterface()
    };
}
exports.createFakeResult = createFakeResult;
function createFakeResultWithChildResult(token, numberOfChildResult, totalNumberOfChildResult) {
    if (totalNumberOfChildResult === void 0) { totalNumberOfChildResult = 5; }
    var childResults = [];
    for (var i = 0; i < numberOfChildResult; i++) {
        childResults.push(createFakeResult(token + "-child" + i));
    }
    var ret = createFakeResult(token);
    ret.totalNumberOfChildResults = totalNumberOfChildResult;
    ret = _.extend(ret, { childResults: childResults });
    return ret;
}
exports.createFakeResultWithChildResult = createFakeResultWithChildResult;
function createFakeResultWithAttachments(token, numberOfAttachments, attachmentType, flags, attachmentsFlags, withSubAttachments) {
    ...
    var fake = createFakeResult(token);
    fake.flags = flags;
    if (withSubAttachments) {
        var subAttachments = [];
        for (var i = 0; i < numberOfAttachments; i++) {
            subAttachments.push(createFakeResultWithAttachments("test1", 3, undefined, undefined, undefined, false));
        }
...
exports.createFakeResultWithAttachments = createFakeResultWithAttachments;
function createFakeFeedItemResult(token, nbLikes, nbTopics, hasAttachment) {
    if (nbLikes === void 0) { nbLikes = 0; }
    if (nbTopics === void 0) { nbTopics = 0; }
    if (hasAttachment === void 0) { hasAttachment = false; }
    var result = createFakeResult(token);
...
exports.createFakeFeedItemResult = createFakeFeedItemResult;
...
Object.defineProperty(exports, "__esModule", { value: true });
var Fake = __webpack_require__(/*! ./Fake */ "./src/Fake.ts");
exports.Fake = Fake;
var Mock = __webpack_require__(/*! ./MockEnvironment */ "./src/MockEnvironment.ts");
exports.Mock = Mock;
var Simulate = __webpack_require__(/*! ./Simulate */ "./src/Simulate.ts");
exports.Simulate = Simulate;


/***/ }),

/***/ "./src/MockEnvironment.ts":
/*!********************************!*\
  !*** ./src/MockEnvironment.ts ***!
  \********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./MockEnvironment/AdvancedComponentsSetup */ "./src/MockEnvironment/AdvancedComponentsSetup.ts"));
__export(__webpack_require__(/*! ./MockEnvironment/BasicComponentsSetup */ "./src/MockEnvironment/BasicComponentsSetup.ts"));
__export(__webpack_require__(/*! ./MockEnvironment/MockComponents */ "./src/MockEnvironment/MockComponents.ts"));
__export(__webpack_require__(/*! ./MockEnvironment/MockEnvironmentBuilder */ "./src/MockEnvironment/MockEnvironmentBuilder.ts"));
__export(__webpack_require__(/*! ./MockEnvironment/OptionsComponentsSetup */ "./src/MockEnvironment/OptionsComponentsSetup.ts"));


/***/ }),

/***/ "./src/MockEnvironment/AdvancedComponentsSetup.ts":
/*!********************************************************!*\
  !*** ./src/MockEnvironment/AdvancedComponentsSetup.ts ***!
  \********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var MockEnvironmentBuilder_1 = __webpack_require__(/*! ./MockEnvironmentBuilder */ "./src/MockEnvironment/MockEnvironmentBuilder.ts");
var coveo_search_ui_1 = __webpack_require__(/*! coveo-search-ui */ "coveo-search-ui");
var Simulate = __webpack_require__(/*! ../Simulate */ "./src/Simulate.ts");
var AdvancedComponentSetupOptions = /** @class */ (function () {
    function AdvancedComponentSetupOptions(element, cmpOptions, modifyBuilder) {
        if (element === void 0) { element = coveo_search_ui_1.$$("div").el; }
        if (cmpOptions === void 0) { cmpOptions = {}; }
        if (modifyBuilder === void 0) { modifyBuilder = function (env) { return env; }; }
...
exports.AdvancedComponentSetupOptions = AdvancedComponentSetupOptions;
function advancedComponentSetup(klass, options) {
    ...
    var envBuilder = new MockEnvironmentBuilder_1.MockEnvironmentBuilder().withElement(optsMerged.element);
    envBuilder = optsMerged.modifyBuilder(envBuilder);
    return {
        env: envBuilder.build(),
        cmp: new (klass.bind.apply(klass, [void 0, envBuilder.getBindings().element,
            optsMerged.cmpOptions,
            envBuilder.getBindings()].concat(args)))()
    };
}
exports.advancedComponentSetup = advancedComponentSetup;
function advancedComponentSetupWithModalBox(klass, options) {
    var args = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        args[_i - 2] = arguments[_i];
    }
    var baseOptions = new AdvancedComponentSetupOptions();
    var optsMerged = baseOptions.merge(options);
    var modalBox = Simulate.modalBoxModule();
    var envBuilder = new MockEnvironmentBuilder_1.MockEnvironmentBuilder().withElement(optsMerged.element);
    envBuilder = optsMerged.modifyBuilder(envBuilder);
    return {
        env: envBuilder.build(),
        ...
        cmp: new (klass.bind.apply(klass, [void 0, envBuilder.getBindings().element,
            ...
            modalBox].concat(args)))()
    };
}
exports.advancedComponentSetupWithModalBox = advancedComponentSetupWithModalBox;
function advancedResultComponentSetup(klass, result, options) {
    ...
    var baseOptions = new AdvancedComponentSetupOptions();
    var optsMerged = baseOptions.merge(options);
    var envBuilder = new MockEnvironmentBuilder_1.MockEnvironmentBuilder()
    ...
    return {
        ...
        cmp: new (klass.bind.apply(klass, [void 0, envBuilder.getBindings().element,
            ...
            envBuilder.getBindings(),
            envBuilder.result,
            envBuilder.os].concat(args)))()
    };
}
exports.advancedResultComponentSetup = advancedResultComponentSetup;


/***/ }),

/***/ "./src/MockEnvironment/BasicComponentsSetup.ts":
/*!*****************************************************!*\
  !*** ./src/MockEnvironment/BasicComponentsSetup.ts ***!
  \*****************************************************/
/*! no static exports found */
...
var coveo_search_ui_1 = __webpack_require__(/*! coveo-search-ui */ "coveo-search-ui");
var Simulate = __webpack_require__(/*! ../Simulate */ "./src/Simulate.ts");
function basicComponentSetup(klass, options) {
...
exports.basicComponentSetup = basicComponentSetup;
function basicComponentSetupWithModalBox(klass, options) {
    if (options === void 0) { options = {}; }
    var args = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        args[_i - 2] = arguments[_i];
...
exports.basicComponentSetupWithModalBox = basicComponentSetupWithModalBox;
function basicResultComponentSetup(klass, options) {
    if (options === void 0) { options = {}; }
    var args = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        args[_i - 2] = arguments[_i];
    }
    var envBuilder = new MockEnvironmentBuilder_1.MockEnvironmentBuilder().withResult();
    return {
        env: envBuilder.build(),
        cmp: new (klass.bind.apply(klass, [void 0, envBuilder.getBindings().element,
            options,
            envBuilder.getBindings(),
            envBuilder.result].concat(args)))()
    };
}
exports.basicResultComponentSetup = basicResultComponentSetup;
function basicResultComponentSetupWithModalBox(klass, options) {
    if (options === void 0) { options = {}; }
    var args = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        args[_i - 2] = arguments[_i];
...
exports.basicResultComponentSetupWithModalBox = basicResultComponentSetupWithModalBox;
function basicSearchInterfaceSetup(klass) {
    var args = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args[_i - 1] = arguments[_i];
    }
    var div = coveo_search_ui_1.$$("div").el;
    var envBuilder = new MockEnvironmentBuilder_1.MockEnvironmentBuilder().withRoot(div);
    var component = new (klass.bind.apply(klass, [void 0, div].concat(args)))();
...
exports.basicSearchInterfaceSetup = basicSearchInterfaceSetup;


/***/ }),

/***/ "./src/MockEnvironment/MockComponents.ts":
/*!***********************************************!*\
  !*** ./src/MockEnvironment/MockComponents.ts ***!
  \***********************************************/
/*! no static exports found */
...
exports.mock = mock;
function mockWindow() {
    var mockWindow = mock(Window.prototype);
    mockWindow.location = {
        href: "",
        hash: ""
    };
...
function mockSearchInterface() {
    var m = mockComponent(coveo_search_ui_1.SearchInterface, coveo_search_ui_1.SearchInterface.ID);
    m.options = {};
    m.options.originalOptionsObject = {};
    m.responsiveComponents = mockResponsiveComponents();
    return m;
}
exports.mockSearchInterface = mockSearchInterface;
function mockResponsiveComponents() {
    return {
        windoh: mockWindow(),
        getMediumScreenWidth: function () { return 0; },
        getSmallScreenWidth: function () { return 0; },
        setMediumScreenWidth: function () { return 0; },
        setSmallScreenWidth: function () { return 0; },
        isSmallScreenWidth: function () { return false; },
        isMediumScreenWidth: function () { return false; },
        isLargeScreenWidth: function () { return true; },
        getResponsiveMode: function () { return "auto"; },
        setResponsiveMode: function () { return null; }
    };
}
exports.mockResponsiveComponents = mockResponsiveComponents;
function mockQueryController() {
    var m = mockComponent(coveo_search_ui_1.QueryController, coveo_search_ui_1.QueryController.ID);
    var spy = m;
    spy.options = {};
    spy.options.resultsPerPage = 10;
    spy.fetchMore.and.returnValue(new Promise(function (resolve, reject) { }));
    spy.getLastQuery.and.returnValue(new coveo_search_ui_1.QueryBuilder().build());
    return m;
}
exports.mockQueryController = mockQueryController;
function mockSearchEndpoint() {
    var m = mock(coveo_search_ui_1.SearchEndpoint, "SearchEndpoint");
    ...
    m.getQuerySuggest.and.returnValue(new Promise(function (resolve, reject) { }));
...
exports.mockSearchEndpoint = mockSearchEndpoint;
function mockUsageAnalytics() {
    var m = mock(coveo_search_ui_1.NoopAnalyticsClient, "AnalyticsClient");
    m.getTopQueries.and.returnValue(new Promise(function (resolve, reject) { }));
    return m;
}
exports.mockUsageAnalytics = mockUsageAnalytics;
function mockAnalyticsEndpoint() {
    var m = mock(coveo_search_ui_1.AnalyticsEndpoint, "AnalyticsEndpoint");
...
exports.mockAnalyticsEndpoint = mockAnalyticsEndpoint;


/***/ }),

/***/ "./src/MockEnvironment/MockEnvironmentBuilder.ts":
/*!*******************************************************!*\
  !*** ./src/MockEnvironment/MockEnvironmentBuilder.ts ***!
  \*******************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var MockComponents_1 = __webpack_require__(/*! ./MockComponents */ "./src/MockEnvironment/MockComponents.ts");
var coveo_search_ui_1 = __webpack_require__(/*! coveo-search-ui */ "coveo-search-ui");
var FakeResults = __webpack_require__(/*! ../Fake */ "./src/Fake.ts");
var MockEnvironmentBuilder = /** @class */ (function () {
    function MockEnvironmentBuilder() {
        this.root = coveo_search_ui_1.$$("div").el;
        this.element = coveo_search_ui_1.$$("div").el;
        this.result = undefined;
        this.searchEndpoint = MockComponents_1.mockSearchEndpoint();
        this.searchInterface = MockComponents_1.mockSearchInterface();
        this.queryController = MockComponents_1.mockQueryController();
        this.queryStateModel = MockComponents_1.mockComponent(coveo_search_ui_1.QueryStateModel, coveo_search_ui_1.QueryStateModel.ID);
        this.componentStateModel = MockComponents_1.mockComponent(coveo_search_ui_1.ComponentStateModel, coveo_search_ui_1.ComponentStateModel.ID);
        this.usageAnalytics = MockComponents_1.mockUsageAnalytics();
        this.componentOptionsModel = MockComponents_1.mockComponent(coveo_search_ui_1.ComponentOptionsModel, coveo_search_ui_1.ComponentOptionsModel.ID);
        this.built = false;
    }
    ...
    MockEnvironmentBuilder.prototype.withLiveQueryStateModel = function () {
        this.queryStateModel = new coveo_search_ui_1.QueryStateModel(this.root);
        return this;
    };
    ...
    MockEnvironmentBuilder.prototype.withResult = function (result) {
        if (result === void 0) { result = FakeResults.createFakeResult(); }
        this.result = result;
        return this;
    };
    MockEnvironmentBuilder.prototype.withEndpoint = function (endpoint) {
        if (endpoint === void 0) { endpoint = MockComponents_1.mockSearchEndpoint(); }
    ...
    MockEnvironmentBuilder.prototype.build = function () {
        ...
        coveo_search_ui_1.Component.bindComponentToElement(this.root, this.searchInterface);
        coveo_search_ui_1.Component.bindComponentToElement(this.root, this.queryController);
        coveo_search_ui_1.Component.bindComponentToElement(this.root, this.queryStateModel);
        coveo_search_ui_1.Component.bindComponentToElement(this.root, this.componentStateModel);
        coveo_search_ui_1.Component.bindComponentToElement(this.root, this.componentOptionsModel);
        ...
        this.searchInterface.getBindings = function () { return _this.getBindings(); };
        this.searchInterface.getQueryContext = function () { return _this.queryController.getLastQuery().context || {}; };
        if (!this.searchEndpoint) {
            this.searchEndpoint = MockComponents_1.mockSearchEndpoint();
        }
        this.queryController.getEndpoint = function () {
            return _this.searchEndpoint;
        };
        if (this.result) {
            coveo_search_ui_1.Component.bindResultToElement(this.element, this.result);
        }
        this.built = true;
        return this.getBindings();
    };
...
exports.MockEnvironmentBuilder = MockEnvironmentBuilder;


/***/ }),

/***/ "./src/MockEnvironment/OptionsComponentsSetup.ts":
/*!*******************************************************!*\
  !*** ./src/MockEnvironment/OptionsComponentsSetup.ts ***!
  \*******************************************************/
/*! no static exports found */
...
function optionsSearchInterfaceSetup(klass, options) {
    ...
    var div = coveo_search_ui_1.$$("div").el;
    var envBuilder = new MockEnvironmentBuilder_1.MockEnvironmentBuilder().withRoot(div);
    var component = new (klass.bind.apply(klass, [void 0, div, options].concat(args)))();
    envBuilder.searchInterface = component;
    return {
        env: envBuilder.build(),
        cmp: component
...
exports.optionsSearchInterfaceSetup = optionsSearchInterfaceSetup;
function optionsResultComponentSetup(klass, options, result) {
    var args = [];
    for (var _i = 3; _i < arguments.length; _i++) {
        args[_i - 3] = arguments[_i];
    }
    var envBuilder = new MockEnvironmentBuilder_1.MockEnvironmentBuilder().withResult(result);
    return {
        env: envBuilder.build(),
        cmp: new (klass.bind.apply(klass, [void 0, envBuilder.getBindings().element,
            options,
...
exports.optionsResultComponentSetup = optionsResultComponentSetup;
function optionsResultComponentSetupWithModalBox(klass, options, result) {
    var args = [];
    for (var _i = 3; _i < arguments.length; _i++) {
        args[_i - 3] = arguments[_i];
    }
...
exports.optionsResultComponentSetupWithModalBox = optionsResultComponentSetupWithModalBox;
...
exports.optionsComponentSetup = optionsComponentSetup;
function optionsComponentSetupWithModalBox(klass, options) {
    var args = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        args[_i - 2] = arguments[_i];
    }
...
exports.optionsComponentSetupWithModalBox = optionsComponentSetupWithModalBox;
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./Simulate/Actions */ "./src/Simulate/Actions.ts"));
__export(__webpack_require__(/*! ./Simulate/Components */ "./src/Simulate/Components.ts"));
__export(__webpack_require__(/*! ./Simulate/Environment */ "./src/Simulate/Environment.ts"));
__export(__webpack_require__(/*! ./Simulate/Modules */ "./src/Simulate/Modules.ts"));
__export(__webpack_require__(/*! ./Simulate/Query */ "./src/Simulate/Query.ts"));


/***/ }),

/***/ "./src/Simulate/Actions.ts":
/*!*********************************!*\
  !*** ./src/Simulate/Actions.ts ***!
  \*********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var coveo_search_ui_1 = __webpack_require__(/*! coveo-search-ui */ "coveo-search-ui");
function keyUp(element, key, shiftKey) {
...
function omnibox(env, options) {
    ...
    coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.OmniboxEvents.populateOmnibox, fakeOmniboxArgs);
    return fakeOmniboxArgs;
}
exports.omnibox = omnibox;
function breadcrumb(env, options) {
    var args = { breadcrumbs: [] };
    coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.BreadcrumbEvents.populateBreadcrumb, args);
...
Object.defineProperty(exports, "__esModule", { value: true });
var JQueryModule_1 = __webpack_require__(/*! ./JQueryModule */ "./src/Simulate/JQueryModule.ts");
function isPhantomJs() {
    return navigator.userAgent.indexOf("PhantomJS") !== -1;
}
exports.isPhantomJs = isPhantomJs;
function isChromeHeadless() {
    return navigator.userAgent.indexOf("HeadlessChrome") !== -1;
}
exports.isChromeHeadless = isChromeHeadless;
function addJQuery() {
    window["Coveo"]["$"] = JQueryModule_1.JQuery;
    return JQueryModule_1.JQuery;
}
exports.addJQuery = addJQuery;
function removeJQuery() {
    window["Coveo"]["$"] = null;
}
exports.removeJQuery = removeJQuery;


/***/ }),

/***/ "./src/Simulate/JQueryModule.ts":
/*!**************************************!*\
  !*** ./src/Simulate/JQueryModule.ts ***!
  \**************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.JQuery = __webpack_require__(/*! exports-loader?window.$!../../lib/jquery.js */ "./node_modules/exports-loader/index.js?window.$!./lib/jquery.js").noConflict(true);


/***/ }),

/***/ "./src/Simulate/Modules.ts":
/*!*********************************!*\
  !*** ./src/Simulate/Modules.ts ***!
  \*********************************/
/*! no static exports found */
...
function modalBoxModule() {
    ...
    modalBox.open.and.returnValue({
        modalBox: coveo_search_ui_1.$$("div", undefined, coveo_search_ui_1.$$("div", { className: "coveo-wrapper" }))
            .el,
        wrapper: coveo_search_ui_1.$$("div", undefined, coveo_search_ui_1.$$("div", { className: "coveo-quickview-close-button" })).el,
        overlay: coveo_search_ui_1.$$("div").el,
        content: coveo_search_ui_1.$$("div").el,
        close: modalBox.close
    });
    return modalBox;
}
exports.modalBoxModule = modalBoxModule;
function analyticsStoreModule(actionsHistory) {
    if (actionsHistory === void 0) { actionsHistory = []; }
    return {
...
var Fake = __webpack_require__(/*! ../Fake */ "./src/Fake.ts");
var coveo_search_ui_1 = __webpack_require__(/*! coveo-search-ui */ "coveo-search-ui");
function query(env, options) {
    options = _.extend({}, {
        query: new coveo_search_ui_1.QueryBuilder().build(),
        ...
        deferSuccess: false,
        cancel: false,
        origin: coveo_search_ui_1.NoopComponent
    }, options);
    ...
    coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.newQuery, newQueryEventArgs);
    var buildingQueryEventArgs = {
        queryBuilder: options.queryBuilder,
        searchAsYouType: false,
        cancel: false
    };
    coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.buildingQuery, buildingQueryEventArgs);
    coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.doneBuildingQuery, buildingQueryEventArgs);
    ...
    coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.duringQuery, duringQueryEventArgs);
    options.callbackDuringQuery();
    var success = function () {
        if (coveo_search_ui_1.Utils.exists(options.error)) {
            ...
            coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.queryError, queryErrorEventArgs);
        }
        else {
            ...
            coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.preprocessResults, preprocessResultsEventArgs);
            ...
            if (options.results.totalCount === 0 ||
                ...
                coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.noResults, noResultsEventArgs);
            ...
            if (noResultsEventArgs.retryTheQuery) {
                ...
                coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.querySuccess, querySuccessEventArgs);
                coveo_search_ui_1.$$(env.root).trigger(coveo_search_ui_1.QueryEvents.deferredQuerySuccess, querySuccessEventArgs);
            }
        }
    ...
    if (options.deferSuccess) {
        coveo_search_ui_1.Defer.defer(success);
    }
    else {
        success();
    }
...
//# sourceMappingURL=CoveoJsSearchTests.js.map